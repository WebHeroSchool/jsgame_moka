...
function generateCardsTemplate(numb, numbInLine, numbLines) {
  ...
  <div class="card">
  <img src="image/card.png" alt="Карта" class="game__card game__card_front">`;
  let imgStringEnd = ``;
  let imgStringBug = `<img src="image/bug.png" alt="Карта с багом" class="game__card game__card_back">
  </div>
  </div>`;
  let imgStringFail = `<img src="image/gameOver.png" alt="Карта ошибки" class="game__card game__card_back">
  </div>
  </div>`;
